...
const Leftcard = (props) => {
    const {isLoading, setisLoading, rendercomponent, onClickGotoComponentFn, user:{profileData}} = props;
        ...
        <>
            <div className="col-lg-12 p-0 to-top">
                ...
                <div className="col-lg-12 p-0 pb-4 profile-details-block text-center">
                    <h2 className="name text-bold m-0 mb-2 font-20 font-lg-20">{profileData.name}</h2>
                    <h4 className="designation font-14 font-lg-16 m-0">{profileData.position}</h4>
                </div>
                ...
                <div className="col-lg-12 p-0 pb-3 profile-details-block text-center">
                    <Link to="/" className="btn border text-white">Download CV</Link>
                </div>
            </div>
        </>
    );
